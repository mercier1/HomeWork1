...
public class Main {
    public static void main(String[] args) {
        ...
        USBank usa = new USBank(722337, "U", Currency.USD, 2000, 2133, 2113, 881);
        EUBank eur = new EUBank(993233, "N", Currency.EUR, 1132, 7653, 2833, 111);
        ChinaBank chi = new ChinaBank(9098899, "CI", Currency.USD, 5004, 1710, 5011, 300);
        ...
        System.out.println(" company is " + user3.getCompanyName());
